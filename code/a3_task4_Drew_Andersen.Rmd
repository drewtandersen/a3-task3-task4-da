...
naples_stats %>% 
  kable(col.names = c("Treatment", #renaming the column names from their variable names
                      ...
                      "Median Diameter (cm)"),
        caption = "Table 1. Summary statistics for two groups of purple urchins on Naples Reef in 2010. Urchins that were located in sections of reef that received annual kelp removal and those in the control group.") %>% 
...
ggplot(data = naples_urchins, aes(size)) +
  ...
  labs(title = "Size Distribution of Purple Urchins in Sections of Annual Kelp Removal and Control ", #adds labels/titles
